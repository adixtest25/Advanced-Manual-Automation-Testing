...
COLLEAGUE_ID VARCHAR(10) PRIMARY KEY,
COL_NAME CHAR(30),
POSITION VARCHAR(25),
...
USE SQL_INVENTORY;
INSERT INTO CORPORATES VALUES('SD1001', 'AAKASH', 'SR DEVELOPER', 'PM3001', '2023-05-10', 90000), ('JD1002', 'RAVISH', 'JR DEVELOPER', 'SD1001', '2024-01-31', '30000');
INSERT INTO CORPORATES VALUES('JT2001', 'PRIYANKA', 'JR TESTER', 'ST2002', '2024-02-15', 20000), ('PM3001', 'GAUTAM', 'PROJECT MANAGER', NULL, '2020-07-01', '150000');
INSERT INTO CORPORATES VALUES('ST2002','SIDDHARTH','SR TESTER','PM3001','2021-12-10', 60000), ('GD4001','RONNIE','GRAPHIC DESIGNER','PM3001','2022-06-01', 45000);
